                ...
                <div className="text-center py-6 px-4 space-y-4">
                  ...
                  <div className="flex flex-wrap gap-2 justify-center pt-2">
                    <a
                      ...
                      className="inline-flex items-center gap-2 px-4 py-2 bg-black hover:bg-zinc-800 text-white rounded-lg transition-all text-sm font-medium shadow-sm border border-zinc-200"
                    >
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="inline-flex items-center gap-2 px-4 py-2 bg-[#0A66C2] hover:bg-[#004182] text-white rounded-lg transition-all text-sm font-medium shadow-sm"
                    >
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="inline-flex items-center gap-2 px-4 py-2 bg-[#1877F2] hover:bg-[#0C63D4] text-white rounded-lg transition-all text-sm font-medium shadow-sm"
                    >
                  ...
                  <button
                    ...
                    className="text-zinc-600 hover:text-zinc-900 text-sm underline underline-offset-2 transition-colors font-medium"
                  >
                    Copy invite link
                  </button>
                </div>
