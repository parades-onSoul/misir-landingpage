                ...
                <div className="flex flex-col gap-3 pt-2">
                  <div className="flex flex-wrap gap-2 justify-center">
                    <a
                      ...
                      className="flex-1 min-w-[120px] inline-flex items-center justify-center gap-2 px-4 py-2.5 bg-black hover:bg-zinc-900 text-white rounded-xl transition-all text-sm font-medium border border-zinc-800 hover:border-zinc-700 shadow-lg hover:shadow-xl hover:-translate-y-0.5"
                    >
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="flex-1 min-w-[120px] inline-flex items-center justify-center gap-2 px-4 py-2.5 bg-[#0A66C2] hover:bg-[#004182] text-white rounded-xl transition-all text-sm font-medium shadow-lg hover:shadow-xl hover:-translate-y-0.5"
                    >
